...
//  FoodTracker
//
//  Created by Jorge Casariego on 31/3/15.
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UISearchControllerDelegate, UISearchResultsUpdating {
    ...
    let kAppId = "3d7a7928"
    let kAppKey = "747e9183ed060970263ad405948b1617"
    ...
    func filterContentForSearch (searchText: String, scope: Int) {
        self.filteredSuggestedSearchFoods = self.suggestedSearchFoods.filter({
            (food : String) -> Bool in
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        //Esta linea hace que se mueva a "Search Result" en la pantalla de busqueda
        self.searchController.searchBar.selectedScopeButtonIndex = 1
        ...
        var task = session.dataTaskWithRequest(request, completionHandler: { (data, response, err) -> Void in
            ...
            if conversionError != nil {
                ...
                if jsonDictionary != nil {
                    ...
                    //Lo que debemos hacer aqui es actualizar el hilo principal sino no vemos lo que pasa y
                    //para eso llamamos de la siguiente manera
